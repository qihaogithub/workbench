...
- 已通过：`corepack pnpm --filter @workbench/agent-service test -- tests/unit/pi-agent.test.ts`
- 已通过：`corepack pnpm check:agent`
- 已通过：`corepack pnpm check:author`
- 已通过：`corepack pnpm --filter @workbench/agent-service test -- tests/unit/model-manager.test.ts tests/unit/pi-agent.test.ts`
