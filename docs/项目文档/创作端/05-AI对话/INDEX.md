...
| [项目清单与语义索引](./技术/12_项目资源清单与语义索引.md) | 项目清单的确定性目录、单列分组概览与按需简介编辑面板、native/generated/human 语义、Authority 覆盖 CAS、knowledge-service generation/FTS、权限过滤、统一 L3 投影和 `searchProjectInventory` |
