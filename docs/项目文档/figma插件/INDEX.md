...
| 日期 | 更新内容 |
|------|----------|
| 2026-08-07 | 创作端画布支持直接粘贴 HTML 代码创建页面：复制 Figma 导出的 HTML 代码后在画布中 Ctrl+V 即可生成原型页，复用现有 HTML 导入解析与本地化流程 |
| 2026-08-05 | 创作端首页新增 Figma 插件安装引导页（`/figma-plugin`，公开访问），提供插件下载与图文安装教程；下载包位于 `public/figma-plugin/Figma-to-Code.zip` |
