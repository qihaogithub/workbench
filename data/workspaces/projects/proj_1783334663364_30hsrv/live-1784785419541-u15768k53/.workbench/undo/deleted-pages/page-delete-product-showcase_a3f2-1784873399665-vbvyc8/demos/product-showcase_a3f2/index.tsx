...
export default function ProductShowcase(props: DemoProps) {
  const {
    heroTitle,
    heroSubtitle,
    ctaLabel,
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <button
            className="text-white px-10 py-4 rounded-full font-semibold text-base shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 hover:scale-105 active:scale-95"
            style={{ backgroundColor: primaryColor }}
          >
            {ctaLabel}
          </button>
      ...
      <section className="py-20 px-6">
        ...
        >
          ...
          <p className="text-white/80 text-lg mb-8 max-w-lg mx-auto">
            加入数千家信任我们的企业，开启智能转型之旅
          </p>
          <button className="bg-white text-gray-900 px-8 py-3.5 rounded-xl font-medium hover:shadow-lg transition-all">
            免费试用
          </button>
        </div>
      </section>
