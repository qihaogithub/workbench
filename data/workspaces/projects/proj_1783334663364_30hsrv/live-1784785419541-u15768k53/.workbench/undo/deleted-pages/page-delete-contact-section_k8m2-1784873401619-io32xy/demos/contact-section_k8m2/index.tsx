...
export default function ContactSection(props: DemoProps) {
  ...
  const moduleOrderDefault = ["hero", "cards", "form"];
  const initialOrder = Array.isArray(moduleOrder) && moduleOrder.length
    ? moduleOrder
    : moduleOrderDefault;
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* 页面内拖拽排序 — 直接拖拽模块标题区域调整顺序 */}
      <Reorder.Group axis="y" values={items} onReorder={setItems} className="relative">
        {items.map((id) => {
          switch (id) {
            case "hero":
              return (
                <Reorder.Item key="hero" value="hero" className="relative cursor-grab active:cursor-grabbing">
                  <section className="pt-32 pb-16 px-6 relative overflow-hidden">
                    <div className="absolute inset-x-0 top-0 h-1 bg-gray-200/50" />
                    <div
            ...
            case "cards":
              return (
                <Reorder.Item key="cards" value="cards" className="relative cursor-grab active:cursor-grabbing">
            ...
            case "form":
              return (
                <Reorder.Item key="form" value="form" className="relative cursor-grab active:cursor-grabbing">
