...
export default function PadBottomPopup({
 ...
 children: [
      ...
      , _jsx('div', { className: "absolute inset-0 bg-black/70 flex items-center justify-center"     , children: 
        _jsxs('div', { className: "w-[375px] flex flex-col"  , children: [
          _jsx('img', {
            src: popupImage,
            alt: "",
            className: "w-full block object-cover"  ,}
          )
          , _jsx('div', { className: "flex flex-col items-center gap-5 px-4 pb-5 pt-2 bg-white rounded-b-[32px]"        , children: 
