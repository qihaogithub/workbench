import {jsxs as _jsxs, jsx as _jsx} from "http://localhost:3200/preview-runtime/vendor/react-jsx-runtime.js";export default function DemoPage({ title = "09 审批流程页面结构" }) {
  return (
    _jsxs('main', { className: "min-h-full bg-white p-7 text-slate-900"   , style: { background: "linear-gradient(180deg, hsl(296 52% 96%), #ffffff 42%)" }, children: [
      _jsxs('nav', { className: "mb-6 flex items-center justify-between text-sm text-slate-600"     , children: [
        _jsx('strong', { className: "text-slate-900", children: "09 审批流程" })
        , _jsx('span', { children: "React 09" })
      ]})
      , _jsxs('section', { className: "mb-5 rounded-md border border-slate-300 bg-white/90 p-6"     , children: [
        _jsx('p', { className: "mb-2 text-xs font-bold uppercase tracking-wide"    , style: { color: "hsl(296 68% 38%)" }, children: "High Fidelity Baseline"  })
      ...
      , _jsxs('section', { className: "mb-5 grid grid-cols-2 gap-3"   , children: [
        ...
        , _jsxs('article', { className: "rounded-md border border-slate-200 bg-white p-4"    , children: [
          ...
          , _jsx('strong', { className: "my-2 block text-2xl"  , children: "50"})
          , _jsx('small', { className: "text-slate-500", children: "流程节点 / 信息块"  })
        ]})
      ...
      , _jsxs('section', { className: "grid grid-cols-[1.1fr_.9fr] gap-4"  , children: [
        _jsxs('div', { className: "rounded-md border border-slate-200 bg-white p-5"    , children: [
          ...
          , _jsx('button', { className: "mt-3 rounded-md px-4 py-2 font-semibold text-white"     , style: { backgroundColor: "hsl(296 64% 42%)" }, children: "主要操作"})
        ]})
