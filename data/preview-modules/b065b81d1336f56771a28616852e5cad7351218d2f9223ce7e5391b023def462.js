import {jsxs as _jsxs, jsx as _jsx} from "http://localhost:3200/preview-runtime/vendor/react-jsx-runtime.js";export default function DemoPage({ title = "12 登录注册页面结构" }) {
  return (
    _jsxs('main', { className: "min-h-full bg-white p-7 text-slate-900"   , style: { background: "linear-gradient(180deg, hsl(47 52% 96%), #ffffff 42%)" }, children: [
      _jsxs('nav', { className: "mb-6 flex items-center justify-between text-sm text-slate-600"     , children: [
        _jsx('strong', { className: "text-slate-900", children: "12 登录注册" })
        , _jsx('span', { children: "React 12" })
      ]})
      , _jsxs('section', { className: "mb-5 rounded-md border border-slate-300 bg-white/90 p-6"     , children: [
        _jsx('p', { className: "mb-2 text-xs font-bold uppercase tracking-wide"    , style: { color: "hsl(47 68% 38%)" }, children: "High Fidelity Baseline"  })
      ...
      , _jsxs('section', { className: "grid grid-cols-[1.1fr_.9fr] gap-4"  , children: [
        _jsxs('div', { className: "rounded-md border border-slate-200 bg-white p-5"    , children: [
          ...
          , _jsx('button', { className: "mt-3 rounded-md px-4 py-2 font-semibold text-white"     , style: { backgroundColor: "hsl(47 64% 42%)" }, children: "主要操作"})
        ]})
