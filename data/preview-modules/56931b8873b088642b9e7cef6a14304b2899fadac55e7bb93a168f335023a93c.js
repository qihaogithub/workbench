      ...
      _jsxs('div', { className: "w-[1133px] min-h-screen relative mx-auto bg-[#ffffff]"    , 'data-figma-id': "153:125523", children: [
        ...
        , _jsxs('div', { className: "w-[780px] left-[177px] top-[587.25px] absolute inline-flex flex-col justify-start items-start gap-5"        , 'data-figma-id': "153:125585", children: [
          ...
          , _jsxs('div', { className: "self-stretch shrink-0 inline-flex justify-start items-center gap-2.5"     , 'data-figma-id': "153:164868", children: [
            _jsx('div', { className: "flex items-center justify-center overflow-hidden rounded-md"    , style: { width: 385, height: 80, backgroundColor: inviteCard1Color, borderRadius: 20 }, children: 
              _jsx('img', { src: inviteCard1Image, alt: "邀请活动图片1", className: "h-full w-auto" ,} )
            })
            , _jsx('div', { className: "flex items-center justify-center overflow-hidden rounded-md"    , style: { width: 385, height: 77.5, backgroundColor: inviteCard2Color, borderRadius: 20 }, children: 
