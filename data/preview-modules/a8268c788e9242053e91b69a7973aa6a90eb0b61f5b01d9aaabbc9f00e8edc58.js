...
function LevelModule({
 ...
 children: [
      ...
      , cards.map((card, i) => {
        const x = _nullishCoalesce(_optionalChain([card, 'access', _5 => _5.position, 'optionalAccess', _6 => _6.x]), () => ( 0));
        const y = _nullishCoalesce(_optionalChain([card, 'access', _7 => _7.position, 'optionalAccess', _8 => _8.y]), () => ( 0));
