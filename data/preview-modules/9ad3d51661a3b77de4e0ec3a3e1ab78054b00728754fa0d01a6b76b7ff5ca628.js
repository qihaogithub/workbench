...
export default function Demo({
 ...
 children: [
      ...
      , _jsxs('div', { className: "absolute left-0 top-[141px] flex h-[585px] w-[375px] flex-col items-center overflow-x-hidden overflow-y-auto bg-white [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"             , children: [
        _jsxs('div', { className: "flex flex-col items-center"  , children: [
          _jsx('img', { src: `${phoneAssetBase}/重磅更新标题.png`, alt: "重磅更新", className: "w-[344px]",} )
          , _jsx('img', { src: field, alt: "手机广告图", className: "h-[180px] w-[344px] object-cover"  ,} )
        ...
        , _jsx('div', { className: "h-[180px] w-[344px] shrink-0 overflow-hidden rounded-[10px] bg-[#d9d9d9]"     , children: 
          _jsx('img', { src: `${phoneAssetBase}/广告图.png`, alt: "轮播广告图", className: "h-full w-full object-cover"  ,} )
        })
