...
function VideoModule({ videoBg, video }) {
  const hasSrc = !!_optionalChain([video, 'optionalAccess', _ => _.url]);
  return (
    _jsx('div', {
      style: {
        alignSelf: "stretch",
 ...
 children: 
          hasSrc ? (
            _jsx('video', {
              src: _optionalChain([video, 'optionalAccess', _2 => _2.url]),
              poster: _optionalChain([video, 'optionalAccess', _3 => _3.poster]),
              controls: true,
              style: { width: "100%", height: "100%", objectFit: "cover", borderRadius: 8 },}
            )
          ) : (
            _jsxs(_Fragment, { children: [
              _optionalChain([video, 'optionalAccess', _4 => _4.poster]) && (
                _jsx('img', {
                  src: video.poster,
                  alt: "视频封面",
                  style: { width: "100%", height: "100%", objectFit: "cover", borderRadius: 8 },}
...
function CollectLottery() {
 ...
 children: 
          _jsx('span', { style: { fontSize: 12, fontWeight: 700, color: "rgba(0,0,0,0.2)", fontFamily: "SF Pro Rounded" }, children: "已获得卡片"
 ...
 children: 
            _jsx('span', { style: { fontSize: 12, fontWeight: 700, color: "#E9E9E9", fontFamily: "SF Pro Rounded" }, children: "未获得卡片"
 ...
 children: [
        _jsxs('div', { style: { display: "flex", gap: 4 }, children: [
          ...
          , _jsx('span', { style: { fontSize: 12, fontWeight: 500, color: "#FF9045" }, children: "1"})
        ]})
        ...
        , _jsx('div', { style: { display: "flex", gap: 4 }, children: 
          _jsx('span', { style: { fontSize: 12, fontWeight: 500, color: "#B2B2B2" }, children: "1"})
        })
      ]})
    ]})
  );
...
function LevelModule({
 ...
 children: [
      ...
      /* 关卡图：按 2 倍坐标换算后定位 */
      , cards.map((card, i) => {
        const x = (_nullishCoalesce(card.x, () => ( 0))) / 2;
        const y = (_nullishCoalesce(card.y, () => ( 0))) / 2;
        ...
        if (card.animation) {
          return (
            _jsx(SvgaPlayer, {
              ...
              autoplay: true,
              style: style,
              fallback: img ? _jsx('img', { src: img, alt: `关卡${i + 1}动画兜底`, style: style,} ) : null,}, i
            )
          );
        }
        if (!img) return null;
        return _jsx('img', { src: img, alt: `关卡${i + 1}`, style: style,}, i );
      })
