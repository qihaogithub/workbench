          ...
          <div className="w-[335px] left-[20px] top-[513px] absolute inline-flex flex-col justify-start items-start gap-3.5" data-figma-id="152:114803">
            <div className="self-stretch shrink-0 pb-3.5 flex flex-col justify-start items-start gap-2" data-figma-id="152:6405">
              ...
              <div className="self-stretch shrink-0 inline-flex justify-start items-center gap-2" data-figma-id="152:6412">
                <div className="flex items-center justify-center overflow-hidden rounded-md" data-slot-type="color" style={{ width: 163.50, height: 64, backgroundColor: inviteCard1Color, borderRadius: 16 }}>
                  <img src={inviteCard1Image} alt="邀请活动图片1" className="h-full w-auto" />
                </div>
                <div className="flex items-center justify-center overflow-hidden rounded-md" data-slot-type="color" style={{ width: 163.50, height: 62, backgroundColor: inviteCard2Color, borderRadius: 16 }}>
