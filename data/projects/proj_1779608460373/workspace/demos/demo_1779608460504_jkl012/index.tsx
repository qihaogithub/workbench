...
export default function PadActivityCard({
  cardTitle = '主标题文案',
  cardSubtitle = '副标题文案',
  cardButtonText = '按钮文案',
  ...restProps
  ...
  return (
    ...
    >
      <div className="flex flex-col overflow-hidden flex-shrink-0 px-10">
        <div className="w-full h-11 rounded" style={{ backgroundColor: '#d1d5db' }} />
        <div className="w-full h-11 rounded mt-2" style={{ backgroundColor: '#d1d5db' }} />
      </div>

      <div className="flex justify-between gap-10 flex-1 pb-[60px]">
        <div className="ml-10 flex-shrink-0">
          <div className="w-[335px] h-[350px] rounded-xl" style={{ backgroundColor: '#d1d5db' }} />
        </div>

        <div className="flex-1 mr-10 flex flex-col gap-5">
          <div className="w-[216px] h-10 rounded-lg" style={{ backgroundColor: '#d1d5db' }} />
