...
function VideoModule({
  ...
  return (
    <div className="relative w-[375px] h-[272px]">
      {bgImg && (
        <img
          src={bgImg}
      ...
      <div className="relative flex items-center justify-center h-full">
        <div className="relative">
          {coverImg && (
            <img
              src={coverImg}
              className="w-[335px] h-[188px] rounded-[20px] object-cover"
              alt=""
            />
          )}
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            >
              ...
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M28.4069 21.6669L11.9289 32.4926C10.4602 33.4575 8.48745 33.0491 7.52256 31.5805C7.18165 31.0616 7 30.4542 7 29.8334L7 8.18182C7 6.42455 8.42455 5 10.1818 5C10.8027 5 11.41 5.18165 11.9289 5.52256L28.4069 16.3483C29.8755 17.3132 30.2839 19.286 29.319 20.7547C29.0805 21.1178 28.77 21.4283 28.4069 21.6669Z"
                fill="white"
              />
            </svg>
          </div>
...
export default function Demo({ modules }: DemoProps) {
  ...
  return (
    <div className="w-[375px] bg-white overflow-hidden">
      <StatusBar />
      <NavBar />
