import {jsxs as _jsxs, jsx as _jsx} from "/data/proj_1779608460371/preview-runtime/preview-runtime/vendor/react-jsx-runtime.js";
 ...
 children: [
      ...
      , _jsxs('div', { className: "absolute left-0 top-[90px] flex h-[592px] w-[1133px] flex-col items-center bg-white"        , children: [
        ...
        , _jsx('div', { className: "shrink-0 overflow-hidden rounded-[12px] bg-white"   , children: 
          _jsx('img', { src: padSingleAdImage, alt: "平板广告图", className: "h-[180px] w-[1005px] object-cover"  ,} )
        })
