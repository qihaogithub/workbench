import {jsxs as _jsxs, jsx as _jsx} from "/data/proj_1784874964275_p0k4ho/preview-runtime/vendor/react-jsx-runtime.js"; function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }
...
const DEFAULT_MODULES = [
  {
    type: "image",
    imageUrl: "/data/proj_1784874964275_p0k4ho/assets/images/ab9472005108b9e0a8fc05b3.png",
  },
  {
    type: "progress",
    progressBgTop: "/data/proj_1784874964275_p0k4ho/assets/images/e42da6dcf611db3d2d1ebd50.png",
    progressBgMiddle: "/data/proj_1784874964275_p0k4ho/assets/images/805ed928744ee218f133e8d0.png",
    progressBgBottom: "/data/proj_1784874964275_p0k4ho/assets/images/b0b1a87384e6d7181be09cc4.png",
  },
  {
    type: "image",
    imageUrl: "/data/proj_1784874964275_p0k4ho/assets/images/345cff787d4ead5b8bacc2bd.png",
  },
  {
    type: "video",
    videoBg: "/data/proj_1784874964275_p0k4ho/assets/images/4ea96ecddfd306e91705d243.png",
    videoCover: "/data/proj_1784874964275_p0k4ho/assets/images/ef6aa004c2158bdab3634f29.png",
  },
  {
    type: "image",
    imageUrl: "/data/proj_1784874964275_p0k4ho/assets/images/766653d583e6f9fcb76f3184.png",
  },
];

const LEVELS_IMAGE = "/data/proj_1784874964275_p0k4ho/assets/images/83cf4a9329843d4b5d1fdc30.png";

function StatusBar() {
  return (
    _jsxs('div', { className: "w-[375px] h-[44px] flex items-center justify-between px-[44px] bg-white"      , children: [
      _jsx('span', { className: "text-sm font-medium text-black"  , children: "9:41"})
      , _jsx('svg', {
        width: "67",
        height: "12",
        viewBox: "0 0 67 12"   ,
...
function NavBar() {
  return (
    _jsxs('div', { className: "w-[375px] h-[44px] flex items-center bg-white"    , children: [
      _jsx('button', { className: "w-[44px] h-[44px] flex items-center justify-center"    , children: 
        _jsx('svg', {
          width: "44",
          height: "44",
          viewBox: "0 0 44 44"   ,
 ...
 children: 
      ...
      , _jsx('div', { className: "flex-1 text-center text-lg font-medium text-black truncate"     , children: "活动详情"

      })
      , _jsx('div', { className: "w-[44px]",} )
    ]})
  );
}

function ImageModule({ imageUrl }) {
  return (
    _jsx('div', { className: "w-[375px]", children: 
      imageUrl ? (
        _jsx('img', { src: imageUrl, className: "w-full object-cover" , alt: "",} )
      ) : (
        _jsx('div', { className: "w-full h-[100px] bg-gray-100 flex items-center justify-center text-gray-400 text-sm"       , children: "图片模块"
...
function ProgressModule({
  ...
  return (
    _jsxs('div', { className: "relative w-[375px]" , children: [
      _jsxs('div', { className: "absolute inset-0 flex flex-col pointer-events-none"    , children: [
        topImg && (
          _jsx('img', { src: topImg, className: "w-full h-[50px] object-cover"  , alt: "",} )
        )
        , midImg && (
          _jsx('div', {
            className: "flex-1",
      ...
      , _jsxs('div', { className: "relative z-10 flex flex-col items-center pt-[30px] pb-[33px] gap-5"       , children: [
        _jsx('img', {
          src: LEVELS_IMAGE,
          className: "w-[335px] h-[383px] object-cover"  ,
          alt: "关卡",}
        )
        , _jsx('button', { className: "w-[180px] h-[44px] bg-[#FCDA00] rounded-[30px] text-[#544300] text-lg font-medium flex items-center justify-center outline outline-3 outline-white -outline-offset-3"             , children: "去学习"
...
function VideoModule({
  ...
  return (
    _jsxs('div', { className: "relative w-[375px]" , children: [
      bgImg && (
        _jsx('img', { src: bgImg, className: "w-full h-auto object-cover"  , alt: "",} )
      )
      , _jsx('div', { className: "absolute inset-0 flex items-center justify-center px-[20px]"     , children: 
        _jsxs('div', { className: "relative w-full max-w-[335px]"  , children: [
          coverImg && (
            _jsx('img', {
              src: coverImg,
          ...
          , _jsx('div', { className: "absolute inset-0 flex items-center justify-center"    , children: 
            _jsxs('svg', {
              width: "70",
              height: "70",
              viewBox: "0 0 70 70"   ,
 ...
 children: [
              ...
              , _jsx('path', { d: "M51 35L27 19L27 51Z"   , fill: "white",} )
            ]})
          })
        ]})
      })
...
function renderModule(module, index) {
  switch (module.type) {
    case "image":
      return _jsx(ImageModule, { imageUrl: module.imageUrl,}, index );
    case "progress":
      return (
        _jsx(ProgressModule, {
          ...
          progressBgBottom: module.progressBgBottom,}, index
        )
      );
    case "video":
      return (
        _jsx(VideoModule, {
          ...
          videoCover: module.videoCover,}, index
        )
      );
    default:
      return (
...
export default function Demo({ modules }) {
  const rawModules =
    _optionalChain([modules, 'optionalAccess', _ => _.items]) && modules.items.length > 0 ? modules.items : DEFAULT_MODULES;
  ...
  return (
    _jsxs('div', { className: "w-[375px] bg-white" , children: [
      _jsxs('div', { className: "sticky top-0 z-50"  , children: [
        _jsx(StatusBar, {} )
        , _jsx(NavBar, {} )
      ]})
