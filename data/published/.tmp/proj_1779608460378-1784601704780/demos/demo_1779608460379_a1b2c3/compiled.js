...
export default function PhoneSquare(props) {
  ...
  const subjects = [
    ...
    { key: 'qita', label: '其他', icon: null, bgClass: 'bg-[#fcf9de]', shadow: 'shadow-[inset_0px_-2px_4px_0px_rgba(250,246,204,1.00)]', textColor: 'text-[#770923]' },
  ];
 ...
 children: [
          ...
          /* 大Banner */
          , _jsxs('div', { className: "w-[335px] h-48 shrink-0 relative overflow-hidden"    , children: [
            /* Banner背景渐变 */
