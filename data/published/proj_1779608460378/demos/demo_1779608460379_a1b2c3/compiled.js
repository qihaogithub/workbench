...
const subjects = [
  { key: 'yuedu', label: '阅读', icon: '/data/proj_1779608460378/assets/images/553c7398a55b6fcc7c89b726.png', bgClass: 'bg-[#fff2ea]', shadow: 'shadow-[inset_0px_-2px_4px_0px_rgba(255,237,224,1.00)]', textColor: 'text-[#6b2d03]' },
  { key: 'yizhi', label: '益智', icon: '/data/proj_1779608460378/assets/images/c4b42023de903cbf569e7fa2.png', bgClass: 'bg-[#eaf9ff]', shadow: 'shadow-[inset_0px_-2px_4px_0px_rgba(224,246,255,1.00)]', textColor: 'text-[#004161]' },
  { key: 'meiyu', label: '美育', icon: '/data/proj_1779608460378/assets/images/000db583d36b8dc1b5e2d045.png', bgClass: 'bg-[#f9f5ff]', shadow: 'shadow-[inset_0px_-2px_4px_0px_rgba(243,235,255,1.00)]', textColor: 'text-[#452270]' },
  { key: 'xiezuo', label: '写作', icon: '/data/proj_1779608460378/assets/images/361da27ba0c6e8ccf08f74d6.png', bgClass: 'bg-[#eefceb]', shadow: 'shadow-[inset_0px_-2px_4px_0px_rgba(229,250,224,1.00)]', textColor: 'text-[#0d5100]' },
  { key: 'yingyu', label: '英语', icon: '/data/proj_1779608460378/assets/images/fbe8962e630824a202f3835b.png', bgClass: 'bg-[#fff0f3]', shadow: 'shadow-[inset_0px_-2px_4px_0px_rgba(255,229,235,1.00)]', textColor: 'text-[#770923]' },
  {
    key: 'qita',
    label: '其他',
    icon: null,
...
export default function PhoneSquare(props) {
  ...
  const {
    ...
    miniBanners = [
      '/data/proj_1779608460378/assets/images/b3e2cd72ca7080a05e5aa1ae.png',
      '/data/proj_1779608460378/assets/images/a3c4cd5a768db8d11e3e10b6.png',
      '/data/proj_1779608460378/assets/images/ecd533f8a7c104b410487463.png',
      '/data/proj_1779608460378/assets/images/967d85d8a4d014ac20497c76.png',
      '/data/proj_1779608460378/assets/images/676d545b7cf21bfded91c366.png',
      '/data/proj_1779608460378/assets/images/b472281280cf736428d48942.png',
    ],
  } = props ;
 ...
 children: [
      ...
      , _jsxs('div', { className: "w-[375px] left-0 top-0 absolute bg-white inline-flex flex-col justify-center items-center overflow-hidden"         , children: [
        ...
        /* 顶部状态栏 */
        _jsx('img', {
          src: "/data/proj_1779608460378/assets/images/fcf610ad88a2402c08300b16.png",
          alt: "status bar" ,
          ...
          , _jsx('div', { className: "w-[335px] shrink-0 pt-6 flex flex-col justify-end items-start"      , children: 
            _jsxs('div', { className: "self-stretch shrink-0 px-1 inline-flex justify-between items-center"     , children: [
              ...
              , _jsxs('div', { className: "h-6 shrink-0 pl-3 pr-1.5 rounded-[99px] outline outline-1 outline-offset-[-1px] outline-[#f4f3f3] flex justify-center items-center gap-0.5"            , children: [
                ...
                , _jsx('svg', {
                  width: "29", height: "16", viewBox: "0 0 29 16"   , fill: "none",
                  className: "relative w-[29.01px] h-4 shrink-0 origin-top-left -rotate-90"     ,
                  xmlns: "http://www.w3.org/2000/svg",
 children: 
                  _jsx('path', { d: "M2 2L14.5 14L27 2"   , stroke: "#b2b2b2", 'stroke-width': "2.5", 'stroke-linecap': "round", 'stroke-linejoin': "round",})
                })
              ]})
            ]})
          })
          ...
          /* 课程卡片 */
          , _jsx('img', {
            src: "/data/proj_1779608460378/assets/images/5cc9b33102d65dd82aea22bf.png",
            alt: "course card" ,
            className: "object-cover max-w-none" ,
      ...
      /* 底部标签栏 */
      , _jsx('img', {
        src: "/data/proj_1779608460378/assets/images/ff56667adcca1c73fa7ac987.png",
        alt: "tabBar",
