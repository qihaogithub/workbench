...
export default function PhoneSquare(props) {
 ...
 children: [
      ...
      , _jsxs('div', { className: "flex-1 flex flex-col items-center overflow-y-auto"    , children: [
        /* 科目图标 */
        _jsx('div', { className: "flex items-center justify-between px-5 gap-[11px] mt-4 w-full"      , children: 
          subjects.map((s) => (
            _jsx('div', {
 ...
 children: 
        ...
        /* 大Banner - 使用配置的图片原始尺寸 */
        , _jsx('div', { className: "w-[335px] mt-4" , children: 
          _jsxs('div', { className: "relative w-full overflow-hidden"  , children: [
            /* 背景图 - 根据前景图比例自动适应 */
            _jsx('img', {
        ...
        /* 小Banner滚动区 */
        , _jsx('div', { className: "w-full pl-4 mt-4 overflow-x-auto hide-scrollbar"    , children: 
          _jsx('div', { className: "flex gap-2" , children: 
            miniBanners.map((url, i) => (
              _jsx('img', {
                ...
                src: url,
                alt: `mini-banner-${i + 1}`,
                className: "h-[91px] w-auto flex-shrink-0"  ,}, i
              )
            ))
          })
        })
