...
export default function PadAfterSchool(props) {
 ...
 children: [
      ...
      /* 主要内容区域 */
      , _jsxs('div', { className: "flex-1 px-16 lg:px-24 xl:px-32 flex flex-col gap-8 mt-5 overflow-y-auto"        , children: [
        /* Banner 广告图 */
        _jsx('div', { className: "w-full h-[160px] rounded-[10px] overflow-hidden flex-shrink-0"    , children: 
          _jsx('img', {
            src: bannerImage,
            alt: "banner",
