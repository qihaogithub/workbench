...
包含 3 个页面：
  ...
  📄 "炫彩卡片展示" → demos/demo_1777965200000_x8k2p9/ (index.tsx + config.schema.json)
  📄 "demo_1778051000000_m5w8p2" → demos/demo_1778051000000_m5w8p2/ (index.tsx + config.schema.json)
