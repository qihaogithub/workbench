      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="grid items-center gap-10 py-14 md:grid-cols-[1.05fr_.95fr] md:py-20">
          <div>
            ...
            <button className="mt-8 rounded-2xl px-5 py-3 text-sm font-bold text-white shadow-[0_5px_0_#142536] transition-transform hover:-translate-y-1 active:translate-y-0" style={{ backgroundColor: buttonBg }}>{primaryButtonText} <span className="ml-3">↗</span></button>
          </div>
