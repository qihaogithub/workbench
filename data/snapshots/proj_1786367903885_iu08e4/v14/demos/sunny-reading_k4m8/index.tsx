...
export default function SunnyReading(_props: DemoProps) {
  return (
    <main className="min-h-[100dvh] bg-[#fff8ed] px-5 py-5 text-[#20344a] sm:px-8">
      <div className="mx-auto max-w-5xl">
        <header className="flex items-center justify-between border-b border-[#e9d8bd] pb-4">
          ...
          <span className="rounded-full bg-[#e6f2ed] px-3 py-1 text-xs font-bold text-[#39715d]">今日开放</span>
        </header>
        ...
        <section className="grid items-center gap-10 py-14 md:grid-cols-[1.05fr_.95fr] md:py-20">
          <div>
            ...
            <h1 className="max-w-xl text-5xl font-black leading-[0.98] tracking-[-0.07em] sm:text-7xl">
              读一个故事，<br /><span className="text-[#df765b]">打开一扇窗。</span>
            </h1>
            <p className="mt-6 max-w-md text-base leading-7 text-[#6d7d87]">用15分钟的共读时光，陪孩子练习想象、表达和倾听。</p>
            <button className="mt-8 rounded-2xl bg-[#20344a] px-5 py-3 text-sm font-bold text-white shadow-[0_5px_0_#142536] transition-transform hover:-translate-y-1 active:translate-y-0">开始今日共读 <span className="ml-3">↗</span></button>
          </div>
          <div className="relative mx-auto aspect-square w-full max-w-[360px] overflow-hidden rounded-[2rem] bg-[#b8dfe0] p-7 shadow-[10px_12px_0_#f0cf91]">
            ...
            <div className="relative flex h-full flex-col justify-between rounded-[1.5rem] border-2 border-dashed border-[#39715d]/40 bg-[#edf8f2]/70 p-6">
              ...
              <div><p className="text-xs font-bold uppercase tracking-[0.16em] text-[#39715d]">今日故事</p><p className="mt-2 text-3xl font-black tracking-tight">云朵<br />邮差</p></div>
        ...
        <footer className="flex flex-wrap justify-between gap-3 border-t border-[#e9d8bd] py-5 text-xs text-[#7f8c91]"><span className="font-bold text-[#20344a]">晨光阅读屋</span><span>让每天的故事，都有一点光。</span></footer>
      </div>
    </main>
  )
}