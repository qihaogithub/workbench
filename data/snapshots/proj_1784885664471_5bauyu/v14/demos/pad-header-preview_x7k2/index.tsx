...
const SUBJECTS = [
  ...
  { key: 'thinking', label: '思维', bottom: '/api/images/img_4FdS0bju2F1CQQ', top: '/api/images/img_gDTg2-XpKAnSVQ', ui: '/api/images/img_Za_pljX94fLiog' },
  ...
  { key: 'english', label: '英语', bottom: '/api/images/img_F_vOdbsBBPMsDg', top: '/api/images/img_CvRtuMj8MGw-TA', ui: '/api/images/img_ooOzlSbai4C74A' },
