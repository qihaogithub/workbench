...
export default function PadHeaderPreview(props: DemoProps) {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-[#eef1f6] px-8 py-7">
      {/* 标题 */}
      <div className="mb-4 text-center">
        <h1 className="text-2xl font-bold tracking-wide text-slate-800">头图背景预览</h1>
        <p className="mt-1 text-sm text-slate-400">Pad 端 · 头部背景</p>
      </div>
