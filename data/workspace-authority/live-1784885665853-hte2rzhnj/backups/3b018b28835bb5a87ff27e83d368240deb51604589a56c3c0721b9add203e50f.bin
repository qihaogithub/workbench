  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#eef1f6] px-4 py-6">
      ...
      <div className="w-[300px]">
        {/* 头图区域 */}
        <div className="relative aspect-[750/540] overflow-hidden rounded-2xl">
          {bg ? (
