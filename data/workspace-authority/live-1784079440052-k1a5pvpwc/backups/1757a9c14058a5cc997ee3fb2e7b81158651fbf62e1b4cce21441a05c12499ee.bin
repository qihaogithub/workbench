...
type PopupMediaType = 'image' | 'svga';
...
function readMediaType(value: unknown): PopupMediaType {
  return value === 'svga' ? 'svga' : 'image';
}


export default function PhonePopup(props: DemoProps) {
  const config = props as PopupConfig;
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 10, display: 'flex', flex: 1, alignItems: 'center', justifyContent: 'center', paddingLeft: '1rem', paddingRight: '1rem' }}>
        <div style={{ position: 'relative', display: 'inline-block', width: '100%', maxWidth: '20rem' }}>
          <div style={{ position: 'absolute', zIndex: 20, cursor: 'pointer', top: '-46px', right: 0 }}>
            <svg width="36" height="36" viewBox="0 0 42 42" fill="none">
              ...
              <path fillRule="evenodd" clipRule="evenodd" d="M26.6199 17.5782C27.126 16.9651 27.0923 16.0559 26.5186 15.4822C25.9091 14.8727 24.9208 14.8727 24.3113 15.4822L21.0002 18.7933L17.6892 15.4822L17.5778 15.381C16.9647 14.8748 16.0555 14.9086 15.4819 15.4822C14.8723 16.0918 14.8723 17.08 15.4819 17.6896L18.7929 21.0006L15.482 24.3115L15.3808 24.4229C14.8746 25.036 14.9083 25.9452 15.482 26.5188C16.0916 27.1284 17.0798 27.1284 17.6893 26.5188L21.0002 23.2079L24.3111 26.5188L24.4225 26.6201C25.0356 27.1263 25.9448 27.0925 26.5185 26.5188C27.128 25.9093 27.128 24.9211 26.5185 24.3115L23.2076 21.0006L26.5186 17.6896L26.6199 17.5782Z" fill="white" />
            </svg>
          </div>
          ...
          {showSvga ? (
            <SvgaPlayer
              ...
              <img src={modalImage} alt="popup" style={{ display: 'block', height: 'auto', width: '100%', borderRadius: '0.5rem' }} />
            )}
        </div>
      </div>
    </div>
