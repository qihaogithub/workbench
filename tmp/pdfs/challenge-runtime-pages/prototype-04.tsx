...
export default function ChallengePrototypePage({ title = page.title }) {
  return (
    _jsx('main', { className: "min-h-screen w-full bg-[#f3f4f6] px-4 py-6 text-[#111827]"     , children: 
...
function PhoneShell({ children, tall, wide }) {
  ...
  return (
    _jsx('div', { className: `w-full ${width} overflow-hidden rounded-[26px] bg-white shadow-xl ring-1 ring-black/10`, children: 
...
function Header({ compact = false }) {
  return (
    _jsxs('header', { className: `flex items-center justify-between px-5 ${compact ? "py-2" : "py-3"}`, children: [
...
function PrimaryButton({ children = page.cta, muted = false }) {
  ...
  return (
    _jsx('button', { className: "h-11 w-full rounded-full px-5 text-sm font-bold shadow-sm transition hover:brightness-95 focus:outline-none focus:ring-2 focus:ring-black/20"           , style: style, children: 
      children
    })
  );
}
...
function TaskCard({ index, title, done = false }) {
  return (
    _jsxs('article', { className: "rounded-[18px] bg-white/90 p-4 shadow-sm ring-1 ring-black/5"     , children: [
...
function VideoPanel({ landscape = false }) {
  return (
    _jsx('div', { className: `${landscape ? "aspect-video" : "aspect-[9/16]"} grid place-items-center rounded-[22px] bg-[#737373] text-white shadow-inner`, children: 
      _jsxs('div', { className: "text-center", children: [
...
function renderPage() {
  if (page.kind === "reward") return _jsx(RewardPage, {} );
  if (page.kind === "detail") return _jsx(DetailPage, {} );
  if (page.kind === "taskCenter") return _jsx(TaskCenterPage, {} );
  if (page.kind === "poemHome") return _jsx(PoemHomePage, {} );
  if (page.kind === "videoPortrait") return _jsx(VideoOnly, { landscape: false,} );
  if (page.kind === "festivalStart") return _jsx(FestivalStartPage, {} );
  if (page.kind === "rules") return _jsx(RulesPage, {} );
  if (page.kind === "timeline") return _jsx(TimelinePage, {} );
  if (page.kind === "animalPopup") return _jsx(AnimalPopupPage, {} );
  if (page.kind === "longFlowA") return _jsx(LongFlowPage, { type: "A",} );
  if (page.kind === "videoLandscape") return _jsx(VideoOnly, { landscape: true,} );
  if (page.kind === "longFlowB") return _jsx(LongFlowPage, { type: "B",} );
  if (page.kind === "taskDialog") return _jsx(TaskDialogPage, {} );
  if (page.kind === "videoPlayer") return _jsx(VideoPlayerPage, {} );
  if (page.kind === "shootEntry") return _jsx(ShootEntryPage, {} );
  if (page.kind === "cameraLive") return _jsx(CameraPage, { confirm: false,} );
  if (page.kind === "generating") return _jsx(GeneratingPage, {} );
  if (page.kind === "cameraConfirm") return _jsx(CameraPage, { confirm: true,} );
  if (page.kind === "materialPreview") return _jsx(MaterialPreviewPage, {} );
  if (page.kind === "shareVideo") return _jsx(ShareVideoPage, {} );
  if (page.kind === "keyboardState") return _jsx(KeyboardStatePage, {} );
  if (page.kind === "generateBottom") return _jsx(GenerateBottomPage, {} );
  if (page.kind === "successModal") return _jsx(SuccessModalPage, {} );
  if (page.kind === "materialList") return _jsx(MaterialListPage, {} );
  if (page.kind === "raceAvailable") return _jsx(RacePage, { done: false,} );
  if (page.kind === "raceDone") return _jsx(RacePage, { done: true,} );
...
function VideoOnly({ landscape }) {
  return (
    _jsxs('div', { className: "flex min-h-[680px] flex-col justify-between p-5"    , children: [
...
function FestivalStartPage() {
  return (
    _jsxs('div', { className: "flex min-h-[680px] flex-col items-center justify-center px-7 text-center"      , children: [
...
function RulesPage() {
  return (
    _jsxs('div', { className: "grid grid-cols-[1fr_112px] gap-4 p-5"   , children: [
...
function TimelinePage() {
  return (
    _jsxs('div', { className: "grid grid-cols-[150px_1fr] gap-4 p-5"   , children: [
...
function LongFlowPage({ type }) {
  ...
  return (
    _jsxs('div', { className: `grid ${type === "B" ? "grid-cols-[1fr_150px]" : "grid-cols-[110px_1fr]"} gap-4 p-5`, children: [
...
function TaskDialogPage() {
  return (
    _jsxs('div', { className: "grid min-h-[760px] grid-cols-[1fr_150px] gap-4 bg-black/60 p-5"     , children: [
...
function VideoPlayerPage() {
  return (
    _jsxs('div', { className: "min-h-[680px] bg-black p-5 text-white"   , children: [
...
function CameraStage({ label, large = false }) {
  return (
    _jsx('section', { className: `mx-5 mt-3 rounded-[24px] bg-white/55 p-4 shadow-inner ${large ? "h-[560px]" : "h-[470px]"}`, children: 
...
function SuccessModalPage() {
  return (
    _jsx('div', { className: "flex min-h-[680px] items-center justify-center bg-black/50 p-6"     , children: 
...
function MaterialListPage() {
  return (
    _jsxs('div', { className: "space-y-4 p-5" , children: [
      _jsx(Header, { compact: true,} )
      , [1, 2, 3, 4].map((group) => (
        _jsx(SceneCard, { title: `素材分组 ${group}`, children: 
