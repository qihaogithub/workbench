...
const outDir = path.resolve('tmp/pdfs/challenge-code-pages');
const editId = process.argv[2] ?? '';
const shouldUpdate = Boolean(editId);

const pages = [
  { n: 1, id: 'prototype-01', title: '首页弹窗-体验包领取', kind: 'reward', accent: 'rose', hero: '5天英语表达体验包', subtitle: '连续闯关解锁口语练习', cta: '立即领取' },
  { n: 2, id: 'prototype-02', title: '详情页-活动入口', kind: 'detail', accent: 'slate', hero: '叫叫小剧场', subtitle: '活动详情与课程入口', cta: '去参与' },
  { n: 3, id: 'prototype-03', title: '任务中心-活动入口', kind: 'taskCenter', accent: 'slate', hero: '任务中心', subtitle: '每日任务与活动卡片', cta: '查看活动' },
  { n: 4, id: 'prototype-04', title: '成了诗仙李白-首页', kind: 'poemHome', accent: 'amber', hero: '一不小心成了诗仙李白', subtitle: '完成关卡，解锁诗词成长路线', cta: '立即体验' },
  { n: 5, id: 'prototype-05', title: '视频竖版占位页', kind: 'videoPortrait', accent: 'zinc', hero: '视频', subtitle: '竖版沉浸播放', cta: '跳过' },
  { n: 6, id: 'prototype-06', title: '端午大作战-启动页', kind: 'festivalStart', accent: 'emerald', hero: '端午大作战', subtitle: '完成端午主题挑战', cta: '开始挑战' },
  { n: 7, id: 'prototype-07', title: '活动规则说明页', kind: 'rules', accent: 'sky', hero: '活动规则', subtitle: '规则、奖励与注意事项', cta: '知道了' },
  { n: 8, id: 'prototype-08', title: '关卡任务列表组件页', kind: 'timeline', accent: 'sky', hero: '关卡任务列表', subtitle: '组件化任务流与右侧配置示例', cta: '保存配置' },
  { n: 9, id: 'prototype-09', title: '动物园奇遇记-首页弹窗', kind: 'animalPopup', accent: 'teal', hero: '动物园奇遇记', subtitle: '点亮动物卡，继续闯关', cta: '立即收集' },
  { n: 10, id: 'prototype-10', title: '任务流程长页A', kind: 'longFlowA', accent: 'slate', hero: '任务流程长页', subtitle: '主页面与说明标注', cta: '继续任务' },
  { n: 11, id: 'prototype-11', title: '视频横版占位页', kind: 'videoLandscape', accent: 'zinc', hero: '视频', subtitle: '横版内容播放', cta: '跳过' },
  { n: 12, id: 'prototype-12', title: '任务流程长页B', kind: 'longFlowB', accent: 'slate', hero: '任务配置长页', subtitle: '多状态任务与标注', cta: '应用配置' },
  { n: 13, id: 'prototype-13', title: '任务详情弹窗页', kind: 'taskDialog', accent: 'teal', hero: '任务详情', subtitle: '卡片弹窗与底部操作', cta: '去完成' },
  { n: 14, id: 'prototype-14', title: '视频播放页', kind: 'videoPlayer', accent: 'zinc', hero: '视频播放', subtitle: '播放控制与全屏入口', cta: '全屏观看' },
  { n: 15, id: 'prototype-15', title: '生成作品-拍摄入口', kind: 'shootEntry', accent: 'orange', hero: '燃棒吧！小主题', subtitle: '选择素材并进入拍摄', cta: '开始拍摄' },
  { n: 16, id: 'prototype-16', title: '拍摄页-实时预览', kind: 'cameraLive', accent: 'orange', hero: '实时预览', subtitle: '动作提示与录制按钮', cta: '完成拍摄' },
  { n: 17, id: 'prototype-17', title: '作品生成页-进度', kind: 'generating', accent: 'orange', hero: '燃棒吧！小主题', subtitle: '作品生成中', cta: '生成作品' },
  { n: 18, id: 'prototype-18', title: '拍摄页-确认动作', kind: 'cameraConfirm', accent: 'orange', hero: '确认动作', subtitle: '手势确认与重拍入口', cta: '确认使用' },
  { n: 19, id: 'prototype-19', title: '作品生成页-素材预览', kind: 'materialPreview', accent: 'orange', hero: '素材预览', subtitle: '键盘态素材与倒计时', cta: '确认生成' },
  { n: 20, id: 'prototype-20', title: '分享视频作品页', kind: 'shareVideo', accent: 'orange', hero: '分享我的作品', subtitle: '视频预览与分享渠道', cta: '立即分享' },
  { n: 21, id: 'prototype-21', title: '作品生成页-键盘态', kind: 'keyboardState', accent: 'orange', hero: '键盘态编辑', subtitle: '输入祝福文案', cta: '继续生成' },
  { n: 22, id: 'prototype-22', title: '作品生成页-底部操作', kind: 'generateBottom', accent: 'orange', hero: '底部操作', subtitle: '键盘收起后的生成入口', cta: '生成作品' },
  { n: 23, id: 'prototype-23', title: '交互弹窗-完成提示', kind: 'successModal', accent: 'slate', hero: '完成提示', subtitle: '交互反馈弹窗', cta: '关闭' },
  { n: 24, id: 'prototype-24', title: '素材选择长页', kind: 'materialList', accent: 'orange', hero: '素材选择', subtitle: '多组素材卡片列表', cta: '确定素材' },
  { n: 25, id: 'prototype-25', title: '竞速任务-可参与', kind: 'raceAvailable', accent: 'lime', hero: '竞速任务', subtitle: '可参与状态', cta: '去补卡' },
  { n: 26, id: 'prototype-26', title: '竞速任务-已完成', kind: 'raceDone', accent: 'lime', hero: '竞速任务', subtitle: '任务已完成状态', cta: '去补卡' },
  { n: 27, id: 'prototype-27', title: '送祝福抽好礼-首页', kind: 'lottery', accent: 'red', hero: '送祝福 抽好礼', subtitle: '抽奖活动首页', cta: '开始抽奖' },
];
...
const page = ${JSON.stringify(page, null, 2)} as const;
...
export default function ChallengePrototypePage({ title = page.title }: ChallengePageProps) {
  return (
...
function PhoneShell({ children, tall, wide }: { children: ReactNode; tall?: boolean; wide?: boolean }) {
  const width = wide ? "max-w-[420px]" : "max-w-[360px]";
  const minHeight = tall ? "min-h-[1120px]" : "min-h-[720px]";
  return (
    <div className={\`w-full \${width} overflow-hidden rounded-[26px] bg-white shadow-xl ring-1 ring-black/10\`}>
...
function Header({ compact = false }: { compact?: boolean }) {
  return (
    <header className={\`flex items-center justify-between px-5 \${compact ? "py-2" : "py-3"}\`}>
...
function PrimaryButton({ children = page.cta, muted = false }: { children?: ReactNode; muted?: boolean }) {
  const style = { backgroundColor: muted ? "#e5e7eb" : theme.pill, color: muted ? "#374151" : "#fff" } satisfies CSSProperties;
  return (
    <button className="h-11 w-full rounded-full px-5 text-sm font-bold shadow-sm transition hover:brightness-95 focus:outline-none focus:ring-2 focus:ring-black/20" style={style}>
      {children}
    </button>
  );
}

function Mascot({ label = "IP" }: { label?: string }) {
  return (
...
function TaskCard({ index, title, done = false }: { index: number; title: string; done?: boolean }) {
  return (
    <article className="rounded-[18px] bg-white/90 p-4 shadow-sm ring-1 ring-black/5">
...
function VideoPanel({ landscape = false }: { landscape?: boolean }) {
  return (
    <div className={\`\${landscape ? "aspect-video" : "aspect-[9/16]"} grid place-items-center rounded-[22px] bg-[#737373] text-white shadow-inner\`}>
      <div className="text-center">
...
function renderPage() {
  if (page.kind === "reward") return <RewardPage />;
  if (page.kind === "detail") return <DetailPage />;
  if (page.kind === "taskCenter") return <TaskCenterPage />;
  if (page.kind === "poemHome") return <PoemHomePage />;
  if (page.kind === "videoPortrait") return <VideoOnly landscape={false} />;
  if (page.kind === "festivalStart") return <FestivalStartPage />;
  if (page.kind === "rules") return <RulesPage />;
  if (page.kind === "timeline") return <TimelinePage />;
  if (page.kind === "animalPopup") return <AnimalPopupPage />;
  if (page.kind === "longFlowA") return <LongFlowPage type="A" />;
  if (page.kind === "videoLandscape") return <VideoOnly landscape />;
  if (page.kind === "longFlowB") return <LongFlowPage type="B" />;
  if (page.kind === "taskDialog") return <TaskDialogPage />;
  if (page.kind === "videoPlayer") return <VideoPlayerPage />;
  if (page.kind === "shootEntry") return <ShootEntryPage />;
  if (page.kind === "cameraLive") return <CameraPage confirm={false} />;
  if (page.kind === "generating") return <GeneratingPage />;
  if (page.kind === "cameraConfirm") return <CameraPage confirm />;
  if (page.kind === "materialPreview") return <MaterialPreviewPage />;
  if (page.kind === "shareVideo") return <ShareVideoPage />;
  if (page.kind === "keyboardState") return <KeyboardStatePage />;
  if (page.kind === "generateBottom") return <GenerateBottomPage />;
  if (page.kind === "successModal") return <SuccessModalPage />;
  if (page.kind === "materialList") return <MaterialListPage />;
  if (page.kind === "raceAvailable") return <RacePage done={false} />;
  if (page.kind === "raceDone") return <RacePage done />;
  return <LotteryPage />;
}
...
function VideoOnly({ landscape }: { landscape: boolean }) {
  return (
    <div className="flex min-h-[680px] flex-col justify-between p-5">
...
function FestivalStartPage() {
  return (
    <div className="flex min-h-[680px] flex-col items-center justify-center px-7 text-center">
      <Mascot label="端午" />
...
function RulesPage() {
  return (
    <div className="grid grid-cols-[1fr_112px] gap-4 p-5">
...
function LongFlowPage({ type }: { type: "A" | "B" }) {
  const cards = type === "A" ? ["入口弹窗", "任务列表", "奖励弹窗", "完成页", "底部导航"] : ["视频任务", "弹窗状态", "素材选择", "分享结果", "规则说明"];
  return (
    <div className={\`grid \${type === "B" ? "grid-cols-[1fr_150px]" : "grid-cols-[110px_1fr]"} gap-4 p-5\`}>
      <section className="space-y-3">
        <Header compact />
...
function TaskDialogPage() {
  return (
    <div className="grid min-h-[760px] grid-cols-[1fr_150px] gap-4 bg-black/60 p-5">
...
function VideoPlayerPage() {
  return (
    <div className="min-h-[680px] bg-black p-5 text-white">
...
function CameraPage({ confirm }: { confirm: boolean }) {
  return (
    <>
      <Header compact />
...
function CameraStage({ label, large = false }: { label: string; large?: boolean }) {
  return (
    <section className={\`mx-5 mt-3 rounded-[24px] bg-white/55 p-4 shadow-inner \${large ? "h-[560px]" : "h-[470px]"}\`}>
...
function SuccessModalPage() {
  return (
    <div className="flex min-h-[680px] items-center justify-center bg-black/50 p-6">
...
function MaterialListPage() {
  return (
    <div className="space-y-4 p-5">
      <Header compact />
      {[1, 2, 3, 4].map((group) => (
        <SceneCard key={group} title={\`素材分组 \${group}\`}>
...
function RacePage({ done }: { done: boolean }) {
  return (
    <>
      <Header />
      <div className="space-y-4 px-5 pb-20">
...
for (const page of pages) {
  const file = path.join(outDir, `${page.id}.tsx`);
  await writeFile(file, renderCode(page));
  generated.push({ pageId: page.id, file });
}
