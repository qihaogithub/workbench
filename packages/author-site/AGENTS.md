# AGENTS.md — @workbench/author-site

> 本文件为 AI 编码代理提供在创作端包中工作的指南。进入本包前仍需先阅读根目录 `AGENTS.md`。

## 包定位

`@workbench/author-site` 是创作端 Next.js 14 App Router 应用，负责登录、项目管理、AI 对话、代码编辑、配置预览、截图联动、发布管理和管理后台。
...
| 知识库、Markdown 文档 | `docs/项目文档/创作端/09-知识库/` |
...
pnpm --filter @workbench/author-site test -- --testPathPattern="screenshot-service.test.ts"
```
