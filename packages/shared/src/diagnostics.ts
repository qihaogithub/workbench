...
const EVENT_PAYLOAD_ALLOWLIST: Record<string, readonly string[]> = {
  ...
  "preview.sandbox_execution_issued": [
    "runtimeType",
    "sandboxPolicyVersion",
    "renderer",
    "executionIdHash",
  ...
  "preview.sandbox_runtime_failed": [
    "runtimeType",
    "sandboxPolicyVersion",
    "renderer",
    "errorCode",
  ...
  "preview.sandbox_screenshot_completed": [
    "runtimeType",
    "sandboxPolicyVersion",
    "renderer",
    "durationMs",
